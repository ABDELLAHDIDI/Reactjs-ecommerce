  ...
  return (
    <Col xs="12" className="cart-item-body my-2 d-flex px-2">
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body><div className='font'>Êtes-vous sûr de supprimer le produit du panier</div></Modal.Body>
        <Modal.Footer>
        ...
        <Row className="justify-content-between">
          <Col sm="12" className=" d-flex flex-row justify-content-between">
            ...
            <div onClick={handleShow} className="d-flex pt-2 " style={{ cursor: "pointer" }}>
              ...
              <div className="cat-text d-inline me-2">Suppression</div>
            </div>
          </Col>
        </Row>
        ...
        <Row className="justify-content-between">
          <Col sm="12" className=" d-flex flex-row justify-content-between">
            <div className="d-inline pt-2 d-flex">
              <div className="cat-text mt-2  d-inline">Quantité</div>
              <input
                value={itemCount}
              ...
              />
              <Button onClick={handeleUpdateCart} className='btn btn-dark' >application</Button>
            </div>
            <div className="d-inline pt-2 barnd-text">{item.price || 0} DH</div>
          </Col>
        </Row>
      </div>
    </Col>
