                    ...
                    <Nav className="me-auto">
                        {
                            user != '' ? (
                                <NavDropdown title={user.name} id="basic-nav-dropdown">
                                    ...
                                    {
                                        user.role === "admin" ? (<NavDropdown.Item href="/admin/allproducts">Panneau de contrôle</NavDropdown.Item>) :
                                         (<NavDropdown.Item href="/user/profile">profile</NavDropdown.Item>)
                                    }
                                    <NavDropdown.Divider />
                                    <NavDropdown.Item onClick={logOut} href="/">déconnexion</NavDropdown.Item>
