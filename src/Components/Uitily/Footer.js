            ...
            <Container className="">
                <Row className="d-flex justify-content-between align-items-center">
                    <Col sm="6" className="d-flex align-items-center ">
                        <div className="footer-shroot ">Termes et conditions</div>
                        <div className="footer-shroot mx-2">politique de confidentialité</div>
                        <div className="footer-shroot mx-2">Contactez-nous</div>
                    </Col>
                    <Col
                        sm="6"
