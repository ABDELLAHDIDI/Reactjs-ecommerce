    ...
    return (
        <Col xs="12" sm="6" md="5" lg="4" className="d-flex">
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body><div className='font'>Êtes-vous sûr de la suppression du produit?</div></Modal.Body>
                <Modal.Footer>
            ...
            <Card
                ...
                <Row className="d-flex justify-content-center px-2">
                    <Col className=" d-flex justify-content-between">
                        <div onClick={handleShow} className="d-inline item-delete-edit">Suppression</div>
